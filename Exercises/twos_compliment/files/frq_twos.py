...
"""
frquestions = {
    "Q1": ["What integer does this sign-magnitude number represent? `10101`", -5],
    "Q2": ["What integer does this sign-magnitude number represent? `01110`?", 14],
    "Q3": ["What integer does this two's complement number represent? `10101`", -11],
    "Q4": ["What integer does this two's complement number represent? `01110`", 14],
    "Q5": ["What is the inverse of the two's complement number? `10101`", 11],
    "Q6": ["What is the inverse of the twos complement value? `01110`", -14],
    "Q7": ["What is `1011` sign extended to 8 bits wide?", 11111011],
    "Q8": ["What is `0001` sign extended to 8 bits wide?", 1],
}
