...
frquestions = {"Q1": ["What is the value of Q at time 3?", "1", "Question 1"],
               ...
               "Q6": ["What time interval does the first falling edge of Q occur?", "6-7", "Question 5"],
               "Q7": ["What time interval does the first rising edge of Q' occur?", "6-7", "Question 5"],
               "Q8": ["What time interval does the next rising edge of Q occur?", "7-8", "Question 5"],
               "Q9": ["What time interval does the next falling edge of Q' occur?", "8-9", "Question 5"],
}
