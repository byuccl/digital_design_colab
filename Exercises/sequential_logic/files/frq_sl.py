...
frquestions = {
    ...
    "Q3": ["In ns:", 0.1, "If the Frequency is 10GHZ what is the Period?"],
    "Q4": ["In ms:", 40, "If the frequency is 25Hz what is the Period?"],
    "Q5": ["In ns", 10, "If the frequency of the Clock is 100MHZ, what is the period?"],
    "Q6": [
        "Number of clock cycles:",
        1000000,
        "So, how many clock cycles in 1/10th of a second? ",
    ],
}
