...
def create_frq(list, index, q_width=500, max_=11111111):
  ...
  return grid
#Question 1  
frq_1 = create_frq(frquestions, 0, 400)
...
#Question 2
frq_2 = create_frq(frquestions, 1, 400)
...
#Question 3
frq_3 = create_frq(frquestions, 2, 400)
...
#Question 4
frq_4 = create_frq(frquestions, 3, 400)
...
#Question 5
frq_5 = create_frq(frquestions, 4, 400)
...
#Question 6
frq_6 = create_frq(frquestions, 5, 400)
