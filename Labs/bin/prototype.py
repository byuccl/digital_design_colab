...
frq_2 = create_frq_int(frquestions, 0, 400)

frq_3 = create_frq_int(frquestions, 0, 400)

frq_4 = create_frq_int(frquestions, 0, 400)

frq_5 = create_frq_int(frquestions, 0, 400)

frq_6 = create_frq_int(frquestions, 0, 400)
frq_7 = create_frq_int(frquestions, 0, 400)

frq_8 = create_frq_int(frquestions, 0, 400)

frq_9 = create_frq_int(frquestions, 0, 400)

frq_11 = create_frq_int(frquestions, 0, 400)

frq_12= create_frq_int(frquestions, 0, 400)
